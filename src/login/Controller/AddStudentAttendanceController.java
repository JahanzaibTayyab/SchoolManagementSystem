 ...
 */
public class AddStudentAttendanceController implements Initializable {
    ...
    {
        if(studentid.getText().isEmpty() || studentname.getText().isEmpty() || studentclass.getText().isEmpty() 
                  )
