 ...
 */
public class MonthlyFeeDetailsReportsController implements Initializable {
...
"FROM\n" +
"     `feedetails` feedetails\n where feedetails.`Month` like('"+month.getValue()+"%') and feedetails.`Year` like('"+year.getValue()+"%') " +
